...
('Pique à glace', 'Un pic à glace est un outil essentiel pour tout barman professionnel ou amateur. Il est conçu pour briser et façonner les blocs de glace en morceaux plus petits, idéaux pour la préparation de cocktails. Cet outil se compose généralement d''un manche robuste et d''une pointe en métal extrêmement affûtée. Il permet de contrôler précisément la taille et la forme des morceaux de glace, offrant une touche d''élégance et de sophistication aux boissons.', 'Assurez-vous que la glace est posée sur une surface stable et que votre main est protégée, soit par un gant soit en tenant la glace avec un torchon épais. Positionnez la pointe du pic à glace sur l''endroit où vous souhaitez briser la glace. Enfoncez doucement mais fermement la pointe dans la glace en utilisant une pression contrôlée. Une fois que la pointe est enfoncée, vous pouvez créer des fissures en tapotant légèrement autour de la zone de pénétration. Cela permet de briser la glace en morceaux de la taille désirée. Utilisez le pic pour séparer délicatement les morceaux de glace. Vous pouvez les ajuster selon la taille et la forme souhaitées pour votre cocktail.', 'Bien que moins sophistiqués, un tournevis et un petit marteau peuvent servir de substituts à un pic à glace en permettant de créer des fissures similaires dans la glace. Un couteau peut également être utilisé pour façonner la glace progressivement. Il est crucial de toujours travailler en toute sécurité !', 'pique_a_glace_1.webp', 'pique_a_glace_2.webp', 'pique_a_glace_3.webp');
